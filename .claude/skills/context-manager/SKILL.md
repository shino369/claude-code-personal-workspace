...
Claude Code has a 200K token context window, but **quality degrades at 20-40% usage**. This skill provides strategies for maintaining high-quality outputs throughout long coding sessions.
